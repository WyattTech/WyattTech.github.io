// (A) Lucas and Petter are trying to compare their BMI (Body Mass Index), which is calculated using the formula:
...
console.log("Lucas's BMI is" +" " + BMI1);
console.log("Petta's BMI is" +" " + BMI2);
